...
class Author(models.Model):
    ...
    date_of_death = models.DateField(help_text='Введите дату смери',
...
class Book(models.Model):
    ...
    isbn = models.CharField(max_length=13, help_text='''Введите ISBN книги. 
                                                        Должно быть 13 символов''',
...
class BookInstance(models.Model):
    ...
    status = models.ForeignKey('Status', on_delete=models.CASCADE, null=True,
                               help_text='Изменить состояние экземпляра', verbose_name='Состояние экземпляра')
